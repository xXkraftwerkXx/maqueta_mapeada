...
/////////////// AGENDA REGIONAL CITAS ////////////////////////

$('.agenda_regional_citas').hover(function(){
    if(!$(img).attr('data-cita')){
        $(img).attr({
            src: 'img/0_REGIONAL_drop-barra-agenda.png',
            usemap: '#regional_home',
            'data-cita':'on'
        });
    }else{
        $(img).attr({
...
$('.exportar_btn').click(function(){
    $(img).attr({
        src:'img/1_REGIONAL_exportar_previo.png',
        usemap:'#exportar'
    });
});
...
$('.exportar_btn_confirma').click(function(){
    $(img).attr({
        src:'img/1_REGIONAL_exportar.png',
...
$('.imprimir_btn').click(function(){
    if(!$(img).attr('data-imprimir')){
        $(img).attr({
            src:'img/1_REGIONAL_imprimir.png',
            usemap:'#imprimir',
            'data-imprimir':'on'
        });
    }else{
